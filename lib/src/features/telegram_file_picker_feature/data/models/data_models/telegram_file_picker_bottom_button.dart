...
class TelegramFilePickerBottomButton {
  ...
  const TelegramFilePickerBottomButton(this.icon);
    ...
    TelegramFilePickerBottomButton(
      Column(
        ...
        children: [
          ...
          Text("Gallery", style: GoogleFonts.aBeeZee(fontSize: 16)),
        ],
      ),
    ),
    TelegramFilePickerBottomButton(
      Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text("File", style: GoogleFonts.aBeeZee(fontSize: 16)),
        ],
      ),
    ),
    TelegramFilePickerBottomButton(
      Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text("Musics", style: GoogleFonts.aBeeZee(fontSize: 16)),
        ],
      ),
    ),
  ];
