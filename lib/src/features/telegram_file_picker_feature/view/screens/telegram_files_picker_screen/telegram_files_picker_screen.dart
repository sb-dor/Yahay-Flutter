...
import 'package:yahay/src/features/telegram_file_picker_feature/view/screens/telegram_app_folder_screen/telegram_browse_app_folder_screen.dart';
import 'package:yahay/src/features/telegram_file_picker_feature/view/screens/telegram_app_folder_screen/telegram_browse_folder_data_screen.dart';
...
class TelegramFilesPickerScreen extends StatefulWidget {
  ...
  @override
  State<TelegramFilesPickerScreen> createState() =>
      _TelegramFilesPickerScreenState();
}
    ...
    widget.parentScrollController.addListener(() {
      if (widget.parentScrollController.offset ==
        ...
        if (_telegramFilePickerStateModel.filePickerScreenSelectedScreen ==
          ...
          // pagination here
          _telegramFilePickerBloc.add(
            const TelegramFilePickerEvents.recentFilesPaginationEvent(),
          );
